...
public class ConsecutiveSession extends JFrame {
	...
	public ConsecutiveSession() {
		...
		setTitle("Forza Timetable Management System - Consecutive Session");
		...
		lblNewLabel_1.setBounds(530, 171, 264, 44);
		...
		JButton btnNewButton_3_1_1_1 = new JButton("Mark As Not Consecutive");
		...
		btnNewButton_3_1_1_1.setBounds(530, 626, 256, 44);
...
private void ShowData() {
		...
		try {
			...
			String sql = "SELECT * FROM Sessions WHERE sessionType = 'consecutive'";
