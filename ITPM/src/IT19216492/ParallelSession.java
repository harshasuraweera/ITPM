...
public class ParallelSession extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ParallelSession frame = new ParallelSession();
	...
	public ParallelSession() {
		...
		setTitle("Forza Timetable Management System - Parallel Session");
		...
		JLabel lblNewLabel_1 = new JLabel("Parallel Session");
		...
		JButton btnNewButton_3_1_1_1 = new JButton("Mark As Not Parallel");
		btnNewButton_3_1_1_1.addActionListener(new ActionListener() {
			...
			Object [] row = new Object[2];
				...
				String query = "DELETE FROM ParallelSession WHERE id = '"+row[0]+"'";      	
		...
		btnNewButton_3_1_1_1.setBounds(505, 614, 245, 44);
...
private void ShowData() {
		...
		try {
			...
			String sql = "SELECT * FROM Sessions WHERE sessionType = 'parallel'";
