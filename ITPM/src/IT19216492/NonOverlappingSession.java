...
public class NonOverlappingSession extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NonOverlappingSession frame = new NonOverlappingSession();
	...
	public NonOverlappingSession() {
		...
		setTitle("Forza Timetable Management System - NonOverlapping Session");
		...
		JLabel lblNewLabel_1 = new JLabel("NonOverlapping Session");
		lblNewLabel_1.setBounds(493, 171, 318, 44);
		...
		JButton btnNewButton_3_1_1_1 = new JButton("Mark As Not NonOverlapping");
		btnNewButton_3_1_1_1.addActionListener(new ActionListener() {
			...
			Object [] row = new Object[2];
				...
				String query1 = "UPDATE Sessions SET sessionType = 'default' WHERE id = '"+row[0]+"'";
		...
		btnNewButton_3_1_1_1.setBounds(530, 613, 281, 44);
...
private void ShowData() {
		...
		try {
			...
			String sql = "SELECT * FROM Sessions WHERE sessionType = 'nonOverlapping'";
